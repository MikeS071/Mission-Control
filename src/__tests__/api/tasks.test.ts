...
describe('task API routes', () => {
  ...
  it.skip('lists tasks with query filters applied', async () => {
    const rows = [
  ...
  it.skip('adds a comment to a task and records a comment event', async () => {
  ...
  it.skip('returns 400 for PATCH /tasks/[id] when task id is invalid', async () => {
    const req = makeRequest(
      'PATCH',
