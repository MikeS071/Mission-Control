    ...
    <div className="space-y-4">
      {gateways.length === 0 && (
        <Card className="border-indigo-700/50 bg-indigo-950/30">
          <CardContent className="py-4 text-sm text-indigo-100">
            ...
            <Link href="/dashboard/connect" className="font-semibold text-indigo-300 hover:text-indigo-200">
      ...
      <Card className="bg-gray-900 border-gray-800">
        ...
        <CardContent className="space-y-2 text-sm text-gray-200">
          ...
          {gateways.length === 0 ? (
            <p className="text-gray-400">No gateway connections yet.</p>
          ) : (
            gateways.map((gateway) => (
              <div key={gateway.id} className="rounded-md border border-gray-800 p-2 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-400">{gateway.url}</p>
                </div>
          ...
          <div>
            <Link href="/dashboard/connect" className="text-indigo-300 hover:text-indigo-200 text-sm">Manage gateways</Link>
          </div>
        </CardContent>
      </Card>
