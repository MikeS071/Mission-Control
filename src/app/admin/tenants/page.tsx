...
export default async function AdminTenantsPage() {
  ...
  try {
    ...
    return (
      <section className="space-y-4 text-gray-100">
        <div className="max-w-6xl rounded-xl border border-red-900/60 bg-red-950/30 px-5 py-4 text-sm text-red-200">
  ...
  return (
    <section className="space-y-6 text-gray-100">
      ...
      <div className="max-w-6xl overflow-hidden rounded-xl border border-gray-800 bg-gray-900/60 shadow-[0_0_0_1px_rgba(31,41,55,0.25)]">
