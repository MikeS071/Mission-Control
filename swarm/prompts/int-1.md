# mc-p1-integrate: Phase 1 integration merge

Merge all Phase 1 feature branches into dev and resolve any conflicts.

Steps:
1. Run `git branch -a | grep feat/mc-` to find Phase 1 branches
