# mc-p6-integrate: Phase 6 integration merge

Merge all Phase 6 feature branches into dev and resolve any conflicts.

Steps:
1. Run `git branch -a | grep feat/mc-` to find Phase 6 branches
